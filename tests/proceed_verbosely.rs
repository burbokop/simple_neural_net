...
fn zero() {
    ...
    let (r0, r1, r2) = net.proceed_verbosely(&[0., 0., 0., 0., 0.], sigmoid);
    assert_eq!(r0, [0.5, 0.5, 0.5, 0.5, 0.5].into());
    assert_eq!(r1, [0.5, 0.5, 0.5, 0.5, 0.5].into());
    assert_eq!(r2, [0.5, 0.5, 0.5, 0.5, 0.5].into());
}
...
fn different_sizes() {
    ...
    let (r0, r1, r2) = net.proceed_verbosely(&[0., 0.], sigmoid);
    assert_eq!(r0, [0.5, 0.5, 0.5].into());
    assert_eq!(r1, [0.5, 0.5, 0.5, 0.5].into());
    assert_eq!(r2, [0.5, 0.5, 0.5, 0.5, 0.5].into());
}
